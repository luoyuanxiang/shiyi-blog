  ...
  <div class="app-container">
    ...
    <el-drawer v-model="drawerVisible" title="云存储配置" direction="rtl" size="40%">
      <el-form :model="ossConfigForm" label-position="left" label-width="100px" :rules="rules"
        ...
        <el-form-item v-if="ossConfigForm.platform === 'ali'" label="端点" prop="endpoint">
          <el-input v-model="ossConfigForm.endpoint" placeholder="请输入端点"/>
        </el-form-item>
      ...
      <div class="dialog-footer">
        <el-button type="primary" v-permission="['sys:oss:submit']" icon="CircleCheck"
                   :loading="ossConfigLoading" @click="handleSaveOssConfig">保存
        </el-button>
      </div>
    </el-drawer>
  </div>
...
import {addOssApi, deleteFileApi, getFileListApi, getOssConfigApi, updateOssApi} from '@/api/file'
...
const rules = reactive<FormRules>({
  ...
  endpoint: [
    {required: true, message: '端点不能为空', trigger: 'blur'}
  ],
})
